...
function Welcome_messageRoutineBegin(snapshot) {
  return async function () {
    ...
    Welcome_messageComponents.forEach( function(thisComponent) {
...
function times_startRoutineBegin(snapshot) {
  return async function () {
    ...
    times_startComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function t_2RoutineBegin(snapshot) {
  return async function () {
    ...
    t_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function end_soundRoutineBegin(snapshot) {
  return async function () {
    ...
    end_soundComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
