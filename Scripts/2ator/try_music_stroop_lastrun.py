...
expName = 'try_music_stroop'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\carelab\\Desktop\\Erik\\Scripts\\2ator\\try_music_stroop_lastrun.py',
