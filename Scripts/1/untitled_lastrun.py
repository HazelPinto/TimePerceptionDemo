...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\carelab\\Desktop\\Erik\\Scripts\\1\\untitled_lastrun.py',
...
for thisTrial in trials:
    ...
    # set up handler to look after randomisation of conditions etc
    distractor = data.TrialHandler(nReps=5.0, method='random', 
        extraInfo=expInfo, originPath=-1,
    ...
    for thisDistractor in distractor:
        ...
        key_resp_2.rt = []
        _key_resp_2_allKeys = []
        sound_1.setSound('C:/Users/carelab/Desktop/Erik/stimuli/a2.wav', hamming=True)
        ...
        _key_resp_3_allKeys = []
        # keep track of which components have finished
        t_2Components = [key_resp_2, sound_1, text_5, stopb, stopl, stopr, text_6, key_resp_3]
        ...
        routineTimer.reset()
    # completed 5.0 repeats of 'distractor'
